...
def coco_collate_fn(batch):
  ...
  """
  all_imgs, all_objs, all_boxes, all_masks, all_triples, all_triplet_masks, all_triplet_contours = [], [], [], [], [], [], []
  #all_imgs, all_objs, all_boxes, all_masks, all_triples = [], [], [], [], []
  all_obj_to_img, all_triple_to_img = [], []
  obj_offset = 0
  # update anything returned by __get_item__ here
  for i, (img, objs, boxes, masks, triples, triplet_masks, triplet_contours) in enumerate(batch):

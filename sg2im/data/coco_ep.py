...
class CocoSceneGraphDataset(Dataset):
  ...
  def __getitem__(self, index):
    ...
    return image, objs, boxes, masks, triples, triplet_masks, extreme_points
...
def coco_collate_fn(batch):
  ...
  """
  all_imgs, all_objs, all_boxes, all_masks, all_triples, all_triplet_masks, all_extreme_points = [], [], [], [], [], [], []
  #all_imgs, all_objs, all_boxes, all_masks, all_triples = [], [], [], [], []
  all_obj_to_img, all_triple_to_img = [], []
  obj_offset = 0
  # update anything returned by __get_item__ here
  for i, (img, objs, boxes, masks, triples, triplet_masks, extreme_points) in enumerate(batch):
  ...
  out = (all_imgs, all_objs, all_boxes, all_masks, all_triples,
         all_obj_to_img, all_triple_to_img, all_triplet_masks, all_extreme_points)
  #out = (all_imgs, all_objs, all_boxes, all_masks, all_triples,
  #       all_obj_to_img, all_triple_to_img)
  return out
